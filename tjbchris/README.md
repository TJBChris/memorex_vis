...
* **ROMS** - Contains ROM images that I have patched for one reasaon or another.
...
* **DOC** - Contains documentation, notes, etc. authored by me during my exploration/testing/etc.
